...
require (
	github.com/darkweak/souin/plugins/echo v1.7.5
...
require (
	...
	github.com/darkweak/souin/plugins/souin/storages v1.7.5 // indirect
...
require (
	...
	github.com/wneessen/go-mail v0.4.4 // direct
